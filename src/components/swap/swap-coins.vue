...
<!--    Coin 1-->
    <div class="flex items-center justify-between">
      ...
      >
        ...
        <div class="text-subtitle1 f-w-800 q-ml-sm">{{ coin1.name }}</div>
<!--              <q-icon name="arrow_drop_down"/>-->
    ...
    <div class="q-mt-xs">
      <q-input
        ...
        :label="coin1.label"
        outlined
        input-class="text-center f-w-800 text-h6"
        type="number"
      >
    ...
    <div class="row items-center justify-between q-mt-md">
      <div class="col-8">
        ...
        >
          ...
          <div class="text-subtitle1 f-w-800 q-ml-sm">{{ coin2.name }}</div>
          <q-icon name="arrow_drop_down"/>
        </q-btn>
      </div>
    </div>
...
<!--    Swap-->
    <div class="absolute-bottom q-pa-lg">
      <q-btn
        ...
        no-caps
        :loading="loading"
        class="swap-button f-w-800 text-h6 q-py-sm full-width rounded-borders-xl"
    ...
    <q-dialog v-model="coinSelectDialog" seamless>
      <q-card style="width: 450px; max-width: 100%; height: 530px">
        ...
        <q-toolbar class="justify-between">
          <div class="text-subtitle1 f-w-800">Select coin</div>
            ...
            <q-list separator>
              ...
              >
                ...
                <q-item-section class="flex justify-between full-width">
                  <div>
                    <div class="f-w-800">{{ coin.name }}</div>
                    <small>{{ coin.label }}</small>
                  </div>
                  <small v-if="coin.balance && !coin.isComingSun" class="f-w-800 absolute-bottom-right text-grey-5">{{ coin.balance | numberFormatter }}</small>

<template>
  ...
  >
    <div class="text-h5 f-w-800 text-uppercase tex"><q-icon name="crisis_alert" size="25px" style="margin-top: -5px"/> Big airdrop!</div>
    <div>Connect wallet and get <span class="f-w-800">3500 DOGS</span></div>
  </q-item>
</template>
